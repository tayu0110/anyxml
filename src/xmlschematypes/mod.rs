...
struct Facets {
    ...
    enumeration: Vec<SchemaValue>,
    whitespace: Option<Whitespace>,
    max_inclusive: Option<SchemaValue>,
    max_exclusive: Option<SchemaValue>,
    min_exclusive: Option<SchemaValue>,
    min_inclusive: Option<SchemaValue>,
    /// if i32::MIN, not set.
    /// if negative, parent type is restricted by its absolute value
    total_digits: i32,
    /// if i32::MIN, not set.
